...
public class CRLManager {
	 ...
	 */
	public static X509CRLHolder createCRL(X509Certificate certificate, PrivateKey privateKey) {
	 ...
	 */
	public static X509CRLHolder updateCRL(X509CRLHolder crl, X509Certificate certificate, PrivateKey privateKey, BigInteger serialNumber, int reason) {
		try {
			Date dateNow = new Date();
	 ...
	 * @return CRL lista
	 */
	public static X509CRL CRLFromCrlHolder(X509CRLHolder crlHolder) {
