...
public class WriteMailClient extends MailClient {
	...
	private static final String korisnikA_jks = "./data/korisnikA.jks";
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            PrivateKey pk = SignEnveloped.readPrivateKey(korisnikA_jks, "1234", "korisnika");
    		Certificate cert = SignEnveloped.readCertificate(korisnikA_jks, "1234", "korisnika");
    		System.out.println("cert : "+cert);
    		System.out.println("private key: " + pk);
    		SignEnveloped.saveDocument(document, "C:\\Users\\Milica\\Downloads\\Projekat_Mail\\Mail Client V2\\data\\obicnaPoruka.xml");
    		SignEnveloped.signDocument(document, pk, cert);
    		SignEnveloped.saveDocument(document, "C:\\Users\\Milica\\Downloads\\Projekat_Mail\\Mail Client V2\\data\\potpisanaPoruka.xml");
    		//dobavljanje javnog kljuca korisnikaB
    		KeyStore keyStoreKorisnikB = KeyStoreReader.readKeyStore(korisnikB_jks, "4321".toCharArray());
    		Certificate certKorisnikB = KeyStoreReader.getCertificateFromKeyStore(keyStoreKorisnikB, "korisnikb");
    		PublicKey javniKorisnikBKljuc = KeyStoreReader.getPublicKeyFromCertificate(certKorisnikB);
            ...
            StreamResult streamResult = new StreamResult(new File("C:\\Users\\Milica\\Downloads\\Projekat_Mail\\Mail Client V2\\data\\poslataPoruka.xml"));
