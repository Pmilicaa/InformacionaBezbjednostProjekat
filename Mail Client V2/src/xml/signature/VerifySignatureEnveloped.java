			...
			if(keyInfo != null) {
			    ...
			    if(keyInfo.containsX509Data() && keyInfo.itemX509Data(0).containsCertificate()) { 
			        ...
			        if(cert != null) {
			        	...
			        	System.out.println("sertifikat nije null");
			        	return signature.checkSignatureValue((X509Certificate) cert);	
			        }else {
			        	System.out.println("sertifikat je null");
			        	return false;	
			        }
			        
			    } else {
			    	System.out.println("opet nesto sertifikat");
			    	return false; 	
			    }
			   
			}else {
				System.out.println("keyinfo je null");
				return false;
			}
		}catch (Exception e) {
			System.out.println("puko je verify");
			e.printStackTrace();
			return false;
		} 
	}
